...
final class LoanController
{
    ...
    public function member(): void
    {
        ...
        $this->loans->refreshReservations();
        ...
        $loans = $this->loans->activeForMember((int) $user['id']); $availableCopies = $this->loans->availableCopies((int) $user['id']); require dirname(__DIR__) . '/views/loans/member.php';
    }
